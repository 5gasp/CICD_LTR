...
sudo ip link set dev ifb0 up # repeat for ifb1, ifb2, ...
...
sudo tc class add dev ens3 parent 1: classid 1:1 htb rate 1mbit
sudo tc class add dev ens3 parent 1:1 classid 1:10 htb rate 1mbit
