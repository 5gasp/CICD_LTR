...
def validate_report(report):
    ...
    for i in range(len(report)-1, -1, -1):
        request = report[i]
        if request["endpoint"] == "/api/v1/UEs" and request["method"] == "GET":
...
def test_nef_get_ue(mini_api_endpoint_to_invoke, reporting_api_ip, 
                            reporting_api_port):
    ...
    print("Test Successful! NApp was able to get a list of UEs from the NEF")
    return 0, "Test Successful! NApp was able to get a list of UEs from the NEF"