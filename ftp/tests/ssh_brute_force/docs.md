...
The SSH Audit Test takes as an input:
...
- The Port of the targe VNF where the SSH Server is Running (optional, default=22) - Env: `ssh_brute_force_target_port`, defined in the Testing Descriptor as `target_port`
