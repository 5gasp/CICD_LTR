...
# @Last Modified time: 2023-05-31 09:48:46
...
def validate_report(report):
    ...
    for i in range(len(report)-1, -1, -1):
        ...
        print("Request")
        print(request)
        if request["endpoint"] == "/api/v1/UEs" and request["method"] == "POST":
...
def test_nef_create_ue(mini_api_endpoint_to_invoke, reporting_api_ip, 
                            reporting_api_port):
    ...
    print("Test Successful! NApp was able to register a new UE in the NEF")
    return 0, "Test Successful! NApp was able to register a new UE in the NEF"