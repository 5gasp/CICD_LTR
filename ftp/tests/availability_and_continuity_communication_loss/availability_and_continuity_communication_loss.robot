...
${availability_and_continuity_bandwidth_UENumber}    8
...
Testing for UE${availability_and_continuity_bandwidth_UENumber}
    ...
    ${result}=  iterateForAUE    ${availability_and_continuity_communication_loss_NEFURL}     ${availability_and_continuity_communication_loss_UENumber}   ${availability_and_continuity_communication_loss_DurationForUE4}
    IF     '${result}' != '-1'
