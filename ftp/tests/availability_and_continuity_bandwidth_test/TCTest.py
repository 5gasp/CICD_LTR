...
def install_requirements():
    ...
    # Install requirements
    requirements_file_path = os.path.join(curr_dir, "dependencies", "requirements.txt")
...
if __name__ == '__main__':
    ...
    # iterateForAUE(nef_url, "5", "30")
    # iterateForAUE(nef_url, "6", "28")
    # iterateForAUE(nef_url, "7", "33")
